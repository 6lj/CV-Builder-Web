...
function updatePreview() {
    ...
    document.getElementById('previewPhone').innerHTML = `
        <span class="contact-icon">
            <svg viewBox="0 0 24 24" fill="#ffffffff" xmlns="http://www.w3.org/2000/svg">
                ...
                1-9.39 0-17-7.61-17-17 0-.55.45-1 
                1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 
                2.45.57 3.57.11.35.03.74-.24 
                1.02l-2.2 2.2z"/>
            </svg>
        </span>
    ...
    document.getElementById('previewEmail').innerHTML = `
        <span class="contact-icon">
            <svg viewBox="0 0 24 24" fill="rgba(255, 255, 255, 1)" xmlns="http://www.w3.org/2000/svg">
        ...
        <span><a href="mailto:${document.getElementById('email').value || 'email@example.com'}">
            ${document.getElementById('email').value || 'Email'}</a></span>`;
